...
const orders = [
  {
    id: "1",
    projectName: "Mattermost Rebranding",
    fixedCost: "true",
    shortDescription: "Creation of desktop application for windows, desktop and mac",
    deadline: "2019-10-01",
    techStack: "React JS, Node, electron js",
    noOfResourcesPlanned: 2,
    spocManager: "Gurpreet Singh",
    pinToDashboard: "false"
  },
  {
    id: "2",
    projectName: "Snapcident",
    fixedCost: "true",
    shortDescription: "Creation of desktop application for windows, desktop and mac",
    deadline: "2019-10-01",
    techStack: "React JS, Node, electron js",
