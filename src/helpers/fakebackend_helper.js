...
const baseUrl = "https://stgphys.appsndevs.com/labmatrics/api/"
...
const postFakeRegister = data => {
  ...
  return axios
    .post(baseUrl + "register", dataSend)
    .then(response => {
...
const onGetproject = () => get(baseUrl + "projects")

const onGettechStack = () => get(baseUrl + "tech-stacks")
const onPosttechStack=(data)=>post(baseUrl+"tech-stack-create",data,LocalData) 
const onDeletetechStack=(data)=>get(baseUrl+`tech-stack-delete/${data?.id}`,LocalData)

const onGetmileStone = () => get(baseUrl + "milestone/list")

// const onGetmileStoneById = () => get(baseUrl + "milestone/list", LocalData)
// Register Method
...
const onPostsprint = data => post(baseUrl + "sprint-create", data, LocalData)

const onPostRiskRegister = data =>
  post(baseUrl + "risk-create", data, LocalData)

const onListsprint = () => get(baseUrl + "sprint/list", LocalData)
const onGetmileStoneById = (id) => get(baseUrl + `milestone-project/${id}`, LocalData)
const onPostcomment = data => post(baseUrl + "comment-create", data, LocalData)
const commentLike = data => post(baseUrl + "is-comment-like", data, LocalData)
const ongetComment = () => get(baseUrl + "comments", LocalData)
// Login Method
